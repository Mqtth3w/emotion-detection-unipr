...
NP_NOTSORTED = 'C:\\Users\\MATTEO\\Desktop\\StackOverflow archive\\stats\\statsLovedDreadedNotSorted.csv'
NP_SORTED = 'C:\\Users\\MATTEO\\Desktop\\StackOverflow archive\\stats\\statsLovedDreadedSorted.csv'
...
with open(STATS, 'r', encoding='utf-8') as inFile, open(NP_NOTSORTED, 'w', encoding='utf-8', newline='') as outFile:
    ...
    writer.writerow(['language', 'lovepct', 'fearpct', 'lovetot', 'feartot'])
    ...
    for row in fileReader:
        ...
        if i <= 11:
            ...
            if (love+fear) != 0:
                pct1=love*100/(love+fear)
                pct2=fear*100/(love+fear)
                
            writer.writerow([lang, pct1, pct2, love, fear])
            love = 0
            fear = 0
            i = 1
...
with open(NP_NOTSORTED, 'r', encoding='utf-8') as inFile, open(NP_SORTED, 'w', encoding='utf-8', newline='') as outFile:
    ...
    next(fileReader) # skip header row
    writer = csv.writer(outFile, delimiter=';')
    writer.writerow(['language','lovepct','fearpct', 'lovetot', 'feartot', 'tot'])
