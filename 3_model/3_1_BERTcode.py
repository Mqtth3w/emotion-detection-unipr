...
STATS = 'C:\\Users\\MATTEO\\Desktop\\StackOverflow archive\\stats\\statsPredictions.csv'
TRAIN = 'C:\\Users\\MATTEO\\Desktop\\StackOverflow archive\\trainingSetBalanced60.csv'
VAL = 'C:\\Users\\MATTEO\\Desktop\\StackOverflow archive\\validationSetBalanced20.csv'
...
for month in range(1, 13):
    ...
    IN = PATH + str(month) + '\\testSetBalanced20.csv'
    OUT = PATH + str(month) + '\\testSetPredictions20.csv'
    ...
    # _ for support because it isn't needed with average="weighted" (return number of salmples for each class) 
